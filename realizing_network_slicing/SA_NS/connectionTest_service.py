...
class TrafficSlicing(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mac_to_port = {
            ...
            5: {"00:00:00:00:00:04": 4, "00:00:00:00:00:05": 5, "00:00:00:00:00:06": 6},
        }
        self.slice_TCport = 9999

        # outport = self.slice_ports[dpid][slicenumber]
        self.slice_ports = {1: {1: 1, 2: 2, 3: 3}, 5: {1: 1, 2: 2, 3: 3}}  # For end switch 1: port 1 with slice 1
        self.end_swtiches = [1, 5]

    @set_ev_cls(ofp_event.EventOFPSwitchFeatures, CONFIG_DISPATCHER)
    def switch_features_handler(self, ev):
        datapath = ev.msg.datapath
        ofproto = datapath.ofproto  # zhe dao di sha yi si?
